...
\section{Datenakquisition - MODIS Zeitreihe V6}
...
\end{itemize}
Um ein Jahr zu rekonstruieren bzw zu filtern werden 46 Datenpunkte verwendet. Dies entspricht den Day of Year von 001 bis 361. 
Da es sich für den in Betracht gezogenen Zeitraum 2000-2020 um 927 Datenpunkte pro Kachel handelt, wurde hier mit Python bzw den Bibliotheken \emph{requets, bs4} ein Webscrabber-Skript geschrieben, welches alle Metadaten für die zu interessierenden Daten erstellt und aus der passenden Ordnerstruktur am USGS Server downloaded. 
...
\subsection{Rekonstruktion und Filtern der Verrauschten MODIS V6 Zeitreihe}
\subsubsection{Savitzky-Golay Filterung mit einem Polynom 2. Grades}
Die Daten der MODIS Zeitreihe liegen mit einer Qualitätsinformation 
