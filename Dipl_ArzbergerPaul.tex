...
\end{itemize}
\begin{figure}[H]
\includegraphics[scale=0.6]{./Grafiken/Fitting/Fitting_method_comparison/comparison_reflectance_values_for_band_2_Raffaelle_ITA_agriculture_1_001_001_001.png}
\caption{\textit{Gegenüberstellung Rohdaten, lineare Interpolation, SG Filterung für einen Zeitraum von 15 Epochen im Raum Raffaelle Italien im NIR mit einer niedrigen Gewichtung für alle ausser der besten Qualitätsstufe ( die hier aber nicht enthalten ist)}}
\label{fig:compare_fit_sg_raf_it_2011_w001}
\end{figure}
Das Ergebnis der Rekonstruktion oder der Filterung kann jedoch durch Ausreisser, die als zu verwendete Datenpunkte laut Qualitätsinformation klassifiziert sind,  beeinträchtigt werden. Diese 
\subsection{DFT}
\subsection{FFT}
\end{document}
